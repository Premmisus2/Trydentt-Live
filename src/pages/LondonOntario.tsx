...
const neighborhoods = [
  ...
  'Westmount', 'Whitehills', 'Oakridge', 'Lambeth', 'Hyde Park',
  'Stoney Creek', 'Argyle', 'Downtown London', 'Old East Village',
  'Sherwood Forest', 'Stoneybrook', 'Pond Mills', 'White Oaks',
  'Westminster', 'Medway'
];

const surroundingCities = [
  'St. Thomas', 'Woodstock', 'Strathroy', 'Ingersoll', 'Tillsonburg',
  'Aylmer', 'Dorchester', 'Komoka', 'Lucan', 'Exeter'
];

const LondonOntario: React.FC = () => {
  return (
    <div className="overflow-hidden bg-slate-50 selection:bg-indigo-600/20 selection:text-indigo-900">
        ...
        <script type="application/ld+json">{`
          {
            ...
            "mainEntity": [
              ...
              {
                "@type": "Question",
                "name": "Do you clean homes in Byron and Masonville?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! We serve all London neighbourhoods including Byron, Masonville, Wortley Village, Old North, Old South, Westmount, Hyde Park, Oakridge, Lambeth, and all surrounding areas within a 40km radius."
                }
              },
              {
                "@type": "Question",
                "name": "Do you offer office cleaning in London, Ontario?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes. Trydentt provides professional commercial cleaning for London offices, retail stores, restaurants, and industrial spaces. We offer flexible after-hours scheduling, custom proposals, and are fully insured and bonded."
                }
              },
              {
                "@type": "Question",
                "name": "Can I book a same-week cleaning in London?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "In most cases, yes. We offer quick turnaround booking for London and surrounding areas. Request a free quote online and we typically respond within 2 hours with availability."
                }
              }
            ]
          }
      ...
      {/* Why London Trusts Trydentt */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900">Why London Trusts Trydentt</h2>
            <p className="text-slate-500 max-w-2xl mx-auto">We're not just another cleaning company. We're your neighbours, committed to keeping London homes and businesses spotless.</p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: <Shield className="w-8 h-8" />, title: 'Fully Insured & Bonded', desc: 'Complete liability coverage and workers\' comp. Your property is protected every visit.' },
              { icon: <Sparkles className="w-8 h-8" />, title: 'Eco-Friendly Products', desc: 'EPA-certified, plant-based products safe for your family, pets, and the London community.' },
              { icon: <Clock className="w-8 h-8" />, title: 'Reliable & Punctual', desc: 'We show up on time, every time. Our multi-point checklist ensures nothing is missed.' }
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 bg-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900">Cleaning Services in London, Ontario</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">From family homes in Byron to offices downtown, we have London covered.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="w-14 h-14 bg-slate-800 text-indigo-400 rounded-2xl flex items-center justify-center mb-6">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900">London Neighbourhoods We Serve</h2>
            <p className="text-slate-500 max-w-2xl mx-auto">From North London to South London, we clean every corner of the Forest City.</p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-16">
            {neighborhoods.map((n, i) => (
              <motion.span
                ...
                className="px-5 py-2.5 bg-indigo-50 text-indigo-700 rounded-full text-sm font-medium border border-indigo-100 hover:bg-indigo-100 transition-colors"
              >
                {n}
              </motion.span>
            ))}
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Plus Surrounding Areas</h3>
            <div className="flex flex-wrap justify-center gap-3">
              {surroundingCities.map((c, i) => (
                <span key={i} className="px-5 py-2.5 bg-slate-100 text-slate-700 rounded-full text-sm font-medium border border-slate-200">
                  {c}
                </span>
              ))}
            </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
              <div className="text-white">
                <h2 className="text-4xl md:text-5xl font-bold mb-8">Ready for a spotless space in London?</h2>
                <p className="text-xl text-indigo-100 mb-10">
                  Join hundreds of London families and businesses who trust Trydentt. Get your free, no-obligation quote today.
                </p>
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <CheckCircle2 className="w-5 h-5 text-indigo-300" />
                    <span className="text-sm font-medium">Same-week booking</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-2xl flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-4 text-sm text-slate-400">Or call us: <a href="tel:+15198713368" className="text-indigo-600 font-semibold">(519) 871-3368</a></p>
              </div>
            </div>
