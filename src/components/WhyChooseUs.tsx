      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-lg text-slate-600 mb-4">
            Finding a cleaning service that is both reliable and affordable can be frustrating.
            Inconsistent quality and hidden costs shouldn't be the norm.
          </p>
          <p className="text-base md:text-lg text-indigo-600 font-medium">
            We deliver qualified professionals, consistent reliability, and fair pricing—guaranteed.
          </p>
        </div>
        ...
        <div className="relative min-h-0 md:min-h-[600px] flex flex-col md:block items-center justify-center">
          ...
          >
            <div className="w-full h-full rounded-full overflow-hidden relative flex items-center justify-center bg-white p-4">
              <img
                src="/canadian-owned.png"
                alt="Trydentt - Canadian Owned and Operated"
